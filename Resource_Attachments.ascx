<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Resource_Attachments.ascx.cs" Inherits="Playngo.Modules.ClientZone.Resource_Attachments" %>
<div class="container">
 <div class="row">
        <div class="col-sm-8">
        ...
        <div class="col-sm-8">
           <ul id="paginator-EventList" class="pagination-purple"></ul>
            ...
            function ReturnAlbum(PictureUrl, PictureID) {
               ...
               window.parent.$('#AddAttachments_Modal').modal('hide');
            }
