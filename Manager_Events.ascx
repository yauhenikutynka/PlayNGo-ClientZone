<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_Events.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_Events" %>
<!-- start: PAGE HEADER -->
<div class="row">
    <div class="col-sm-12"> 
        ...
        <h1><i class="fa clip-calendar"></i> <%=ViewResourceText("Header_Title", "All Events")%>
          ...
          <div class="form-group">
            <asp:GridView ID="gvEventList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvEventList_RowDataBound" OnRowCreated="gvEventList_RowCreated" OnSorting="gvEventList_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Address" HeaderText="Address" SortExpression="Address" HeaderStyle-CssClass="hidden-xs" ItemStyle-CssClass="hidden-xs" /> 
