...
{
    public partial class Manager_Events : BaseModule
    {
        ...
        public String CurrentUrl
        {
            get
            {
                ...
                return xUrl("", "", "Events", urls.ToArray());
            }
        }
        ...
        private void BindPageItem()
        {
            ...
            hlAllEvent.NavigateUrl = xUrl("Status", "-1", "Events");
            hlPublishedEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Published).ToString(), "Events");
            hlPendingEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Pending).ToString(), "Events");
            hlDraftsEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Draft).ToString(), "Events");
            hlRecycleBinEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Recycle).ToString(), "Events");
            ...
            hlAddNewLink.NavigateUrl = xUrl("Events-Edit");
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            if (!IsAdministrator && !IsAdmin)
            {
                Where.Add(new SearchParam(Playngo_ClientZone_Event._.CreateUser, UserId, SearchType.Equal));
            }

            //筛选文章的状态
            if (EventStatus >= 0)
            {
                Where.Add(new SearchParam(Playngo_ClientZone_Event._.Status, EventStatus, SearchType.Equal));
            }
            ...
            if (!String.IsNullOrEmpty(Search_Title))
            {
                ...
                Where.Add(new SearchParam(Playngo_ClientZone_Event._.Title, Common.ReplaceEscape(HttpUtility.UrlDecode(Search_Title)), SearchType.Like));
            }
