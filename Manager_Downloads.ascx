<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_Downloads.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_Downloads" %>
<!-- start: PAGE HEADER -->
<div class="row">
    <div class="col-sm-12"> 
        ...
        <h1><i class="fa clip-download"></i> <%=ViewResourceText("Header_Title", "All Downloads")%>
          ...
          <div class="form-group">
            <asp:GridView ID="gvEventList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvEventList_RowDataBound" OnRowCreated="gvEventList_RowCreated" OnSorting="gvEventList_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                           ...
                           <%-- <asp:BoundField DataField="GameID" HeaderText="Game ID" SortExpression="GameID" HeaderStyle-CssClass="hidden-xs" ItemStyle-CssClass="hidden-xs" /> --%>
