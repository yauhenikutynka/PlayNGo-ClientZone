<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_Campaigns.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_Campaigns" %>
<!-- start: PAGE HEADER -->
<div class="row">
    <div class="col-sm-12"> 
        ...
        <h1><i class="fa fa-dot-circle-o"></i> <%=ViewResourceText("Header_Title", "All Campaigns")%>
          ...
          <div class="form-group">
            <asp:GridView ID="gvEventList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvEventList_RowDataBound" OnRowCreated="gvEventList_RowCreated" OnSorting="gvEventList_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="GameID" HeaderText="Document ID" SortExpression="GameID" HeaderStyle-CssClass="hidden-xs" ItemStyle-CssClass="hidden-xs" /> 
