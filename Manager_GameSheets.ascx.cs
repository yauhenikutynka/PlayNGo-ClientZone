...
{
    public partial class Manager_GameSheets : BaseModule
    {
        ...
        public String CurrentUrl
        {
            get
            {
                ...
                return xUrl("", "", "GameSheets", urls.ToArray());
            }
        }
        ...
        private void BindPageItem()
        {
            ...
            hlAllEvent.NavigateUrl = xUrl("Status", "-1", "GameSheets");
            hlPublishedEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Published).ToString(), "GameSheets");
            hlPendingEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Pending).ToString(), "GameSheets");
            hlDraftsEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Draft).ToString(), "GameSheets");
            hlRecycleBinEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Recycle).ToString(), "GameSheets");
            ...
            hlAddNewLink.NavigateUrl = xUrl("GameSheets-Edit");
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            if (!IsAdministrator && !IsAdmin)
            {
                Where.Add(new SearchParam(Playngo_ClientZone_GameSheet._.CreateUser, UserId, SearchType.Equal));
            }

            //筛选文章的状态
            if (EventStatus >= 0)
            {
                Where.Add(new SearchParam(Playngo_ClientZone_GameSheet._.Status, EventStatus, SearchType.Equal));
            }
            ...
            if (!String.IsNullOrEmpty(Search_Title))
            {
                ...
                Where.Add(new SearchParam(Playngo_ClientZone_GameSheet._.Title, Common.ReplaceEscape(HttpUtility.UrlDecode(Search_Title)), SearchType.Like));
            }
