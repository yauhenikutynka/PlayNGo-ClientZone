<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_Jurisdictions.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_Jurisdictions" %>
      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h1><i class="fa fa-globe"></i> <%=ViewResourceText("Header_Title", "Jurisdictions")%></h1>
          </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-12"><i class="fa fa-plus"></i> <%=ViewResourceText("Title_AddNew", "Add New Jurisdictions")%> </div>
                </div>
              </div>
              <div class="form-group">
                <%=ViewControlTitle("lblName", "Name", "txtName", ":", "")%>
                <asp:TextBox runat="server" ID="txtName" CssClass="form-control  validate[required]" placeholder="Jurisdiction Name"></asp:TextBox>
                <p><%=ViewHelp("lblName", "Enter the jurisdiction name")%></p>
              </div>
              <div class="form-group">
               ...
               <div class="col-sm-12 input-group">
                ...
                <div class="input-group-btn">
                    <asp:LinkButton ID="btnSearch" runat="server" CssClass="btn btn-primary" 
                      Text="<i class='fa fa-search'></i>" onclick="btnSearch_Click"  OnClientClick="CancelValidation();"/>
				</div>
              ...
              <asp:GridView ID="gvEventList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvEventList_RowDataBound" OnRowCreated="gvEventList_RowCreated" OnSorting="gvEventList_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Picture">
                                <ItemTemplate>
                                    <asp:HyperLink ID="hlPicture" runat="server" CssClass="" Target="_blank"></asp:HyperLink>
                                </ItemTemplate>
                             </asp:TemplateField>
