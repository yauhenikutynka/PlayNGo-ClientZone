...
namespace Playngo.Modules.ClientZone {
	public class Resource_FilesStatus {
        ...
        public Resource_FilesStatus(Playngo_ClientZone_Files PhotoItem, PortalSettings ps, String ModulePath) { SetValues(PhotoItem, PhotoItem.FileSize, ps, ModulePath); }

        public Resource_FilesStatus(Playngo_ClientZone_Files PhotoItem, int fileLength, PortalSettings ps, String ModulePath) { SetValues(PhotoItem, fileLength, ps, ModulePath); }
        ...
        /// <returns></returns>
        public String GetPhotoPath(Playngo_ClientZone_Files media, PortalSettings ps)
        {
