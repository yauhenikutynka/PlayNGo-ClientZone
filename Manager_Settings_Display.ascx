<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_Settings_Display.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_Settings_Display" %>
<!-- start: PAGE HEADER -->
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-horizontal">
                   ...
                   <div class="form-group">
                        <%=ViewControlTitle("lblModulePageType", "Module Page Type", "ModulePageType", ":", "col-sm-3 control-label")%>
                        <div class="col-sm-5">
                            <div class="control-inline">
                                <asp:DropDownList ID="ddlModulePageType" runat="server" CssClass="form-control input_text validate[required]"></asp:DropDownList>
