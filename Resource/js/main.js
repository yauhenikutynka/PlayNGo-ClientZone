        ...
        filter.each(function () {
            ...
            function checkboxAll() {
                if (all.is(':checked')) {
                    ...
                    aInput.parent().addClass("checked");
                } else {
                    aInput.prop('checked', false);
                    aInput.parent().removeClass("checked");
                };
            };

            function checkboxInput() {
                var checked = $this.find("table .checked");
...
var __dnn_KeyDown = function (iKeyCode, sFunc, e) {
    if (e == null)
        e = window.event;
