<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_ProductRoadmap.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_ProductRoadmap" %>
<!-- start: PAGE HEADER -->
<div class="row">
<div class="col-sm-12"> 
    ...
    <div class="page-header">
        <h1>
            <i class="fa clip-popout"></i> <%=ViewResourceText("Header_Title", "Product Roadmap")%>
        </h1>
    </div>
...
<div class="row">
    <div class="col-sm-8">
        ...
        <div class="panel panel-default div-full-dynamic-modules">
            <div class="panel-heading">
                <i class="fa clip-grid-2"></i> <%=ViewResourceText("Title_DynamicModules", "Dynamic Modules")%>
                <div class="panel-tools">
                    <a href="#" class="btn btn-xs btn-link panel-collapse collapses"></a>
                </div>
            </div>
    ...
    <div class="col-sm-4">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa clip-settings"></i> <%=ViewResourceText("Title_Settings", "Settings")%>
                <div class="panel-tools">
                    <a href="#" class="btn btn-xs btn-link panel-collapse collapses"></a>
                </div>
            </div>
            <div class="panel-body buttons-widget">
                <ul class="Edit_List" id="accordion">
                    <li>
                        <p>
                      <i class="fa clip-calendar-3"></i>&nbsp;<%=ViewResourceText("Title_Start", "Start")%>: </p>
                    ...
                    <li  id="divFeature" runat="server">
                        <div class="panel-collapse" id="Feature">
                            <div class="row form-group">
                               <%=ViewControlTitle("lblIncludedSections", "Included Sections", "cblIncludedSections", ":", "col-sm-3 control-label")%>
                                <div class="col-sm-9">
                                    <div class="checkbox-inline">
                                        <asp:CheckBoxList ID="cblIncludedSections" runat="server" CssClass="auto"></asp:CheckBoxList>
                                    </div>
                                </div>
                            </div>
                        </div>
