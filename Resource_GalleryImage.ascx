<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Resource_GalleryImage.ascx.cs" Inherits="Playngo.Modules.ClientZone.Resource_GalleryImage" %>
<div class="container">
    <div class="row">
        <div class="col-sm-8">
        ...
        <div class="col-sm-8">
           <ul id="paginator-EventList" class="pagination-purple"></ul>
            ...
            function ReturnAlbum(PictureUrl, PictureID) {
               ...
               window.parent.$('#AddAlbums_Modal').modal('hide');
            }
