       ...
       /// <returns></returns>
        ...
        public static String LoadUpdateVersion(String ModuleName, String Version)
        {
            try
            {
                ...
                string xmlPath = "http://www.Playngo.net/ModuleVersion.xml";
                allXml.Load(xmlPath);
        ...
        {
            Downloadlink = "http://www.Playngo.net/";
        ...
        public static string GetCurrentCulture()
        {
            ...
            return Convert.ToString(Thread.CurrentThread.CurrentCulture);
        }
        #endregion
        ...
        /// <param name="realaceValue"></param>
        /// <returns></returns>
        public static String ReplaceEscape(string realaceValue)
        {
        ...
        /// <param name="realaceValue"></param>
        /// <returns></returns>
        public static String RestoreEscape(string realaceValue)
        {
            String ContentText = realaceValue;
            ContentText = ReplaceNoCase(ContentText, "&#39;", "'");
            ContentText = ReplaceNoCase(ContentText, "&quot;", "\"");
        ...
        /// <returns></returns>
        public static Boolean Contains(String ContentText, String Str)
        {
            return !String.IsNullOrEmpty(ContentText) && ( ContentText.IndexOf(Str, StringComparison.CurrentCultureIgnoreCase) >= 0 || ContentText.ToUpper() == Str.ToUpper());
        }
        #endregion
        ...
        /// <returns></returns>
        public static String GetStringByList(String[] strings, String separator = ",")
        {
            return GetStringByList(Split<String>(strings,1,9999), separator);
        }
        ...
        public static String GetStringByList(List<String> list, String separator)
        {
            ...
            if (list != null && list.Count > 0)
            {
                foreach (String str in list)
                {
                    ...
                    {
                        sb.AppendFormat("{0}{1}",separator, str);
                    }
                }
            }
            return sb.ToString();
        ...
        /// <returns></returns>
        public static T SetPropertyValue<T>(T t, String PropertyName, object PropertyValue)
        {
            if (t != null)
            {
                Type typeT = typeof(T);
                List<System.Reflection.PropertyInfo> Propertys = Split<System.Reflection.PropertyInfo>(typeT.GetProperties(), 0, 999);
        ...
        public static T GetPropertyValue<T>(object obj, String PropertyName, T DefaultValue)
        {
            ...
            if (t != null)
            {
                List<System.Reflection.PropertyInfo> Propertys = Split<System.Reflection.PropertyInfo>(obj.GetType().GetProperties(), 0, 999);
                if (Propertys.Exists(r => r.Name == PropertyName))
                {
                    System.Reflection.PropertyInfo Property = Propertys.Find(r => r.Name == PropertyName);
                    if (Property != null && Property.Name == PropertyName)
                    {
                        ...
                        t = (T)Convert.ChangeType(o, Property.PropertyType);
                    }
                }
            }
            return t;
        ...
        /// 回车替代点击事件
        /// </summary>
        /// <param name="ClientID">回车需要出发按钮的名称</param>
        /// <returns></returns>
        public static String EnterClick(String ClientID)
        {
            return String.Format("onkeydown=\"return __dnn_KeyDown('13', 'javascript:__doPostBack(%27{0}%27,%27%27)', event);\"", ClientID);

        }
        #endregion

        #region "替换XML中的ASCII字符"
        /// <summary>
        /// 替换XML中的ASCII字符,以免报错
        /// </summary>
        ...
        /// <param name="o"></param>
        /// <returns></returns>
        public static Dictionary<String, Object> UpdateDictionary(Dictionary<String, Object> Dicts, String Name, Object o)
        {
        ...
        /// <param name="Name"></param>
        /// <returns></returns>
        public static Dictionary<String, Object> RemoveDictionary(Dictionary<String, Object> Dicts, String Name)
        {
            if (Dicts.ContainsKey(Name))
            {
                Dicts.Remove(Name);
