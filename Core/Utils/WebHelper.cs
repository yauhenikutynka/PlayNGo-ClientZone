...
namespace Playngo.Modules.ClientZone
{
    ...
    public static class WebHelper
    {
        ...
        /// <param name="errorReturn">The error return.</param>
        /// <returns>The param value.</returns>
        public static long GetLongParam(System.Web.HttpRequest request, string paramName, long errorReturn)
        {
            string retStr = request.Form[paramName];
            if (retStr == null)
            {
        ...
        public static DateTime GetDateTimeParam(System.Web.HttpRequest request, string paramName, DateTime errorReturn)
        {
            ...
            try
            {
                //return (DateTime)ConvertTo.FormatValue(HttpUtility.UrlDecode(retStr),typeof(DateTime)); // ConvertTo.FormatValue(HttpUtility.UrlDecode(retStr),typeof(DateTime));
                return ConvertDateTime( HttpUtility.UrlDecode(retStr));
            }
            catch
            {
                return errorReturn;
