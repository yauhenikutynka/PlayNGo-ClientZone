...
namespace Playngo.Modules.ClientZone
{
    ...
    public class GenerateThumbnail
    {
        ...
        public static void PushThumbnail(string pathImageFrom, string ThumbnailPath, int width, int height, string mode)
        {
        ...
        public static MemoryStream MakeThumbnail(string originalImagePath, int width, int height, string mode)
        {
             ...
             if (fi.Exists)
             {
                 ...
                 else
                 {
                     ...
                     ep.Param[0] = new System.Drawing.Imaging.EncoderParameter(System.Drawing.Imaging.Encoder.Quality, (long)80);
