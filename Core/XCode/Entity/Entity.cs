...
namespace Playngo.Modules.ClientZone
{
    ...
    public class Entity<TEntity> : ICloneable where TEntity : Entity<TEntity> , new()
    {
        ...
        public static String FindAllToSQL(String whereClause, String orderClause, String selects, Int32 startRowIndex, Int32 maximumRows)
        {
            return PageSplitSQL(whereClause, orderClause, selects, startRowIndex, maximumRows);
        }
        ...
        public static String FindAllToSQL(QueryParam qp, out int RecordCount)
        {
            //构造排序字段
            string orderClause = null;
            if (qp.Orderfld == string.Empty || qp.Orderfld == "")
            ...
            qp.RecordCount = RecordCount = FindCount(WhereCase, null, null, 0, 0);
            //返回所有结果集
            return FindAllToSQL(WhereCase, orderClause, qp.ReturnFields, qp.startRowIndex, qp.PageSize);
        }
        ...
        /// <param name="qp"></param>
        /// <returns></returns>
        public static String BuilderSelect(QueryParam qp)
        {
            //构造排序字段
            string orderClause = null;
            if (qp.Orderfld == string.Empty || qp.Orderfld == "")
            ...
            return PageSplitSQL(WhereCase, orderClause, qp.ReturnFields, qp.startRowIndex, qp.PageSize);
        }
        #endregion
