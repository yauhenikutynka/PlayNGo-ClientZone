...
namespace Playngo.Modules.ClientZone
{
	...
	/// 分类表
	/// </summary>
	public partial class Playngo_ClientZone_CampaignCategory : Entity<Playngo_ClientZone_CampaignCategory>
	{
		#region 对象操作
		...
		public static Playngo_ClientZone_CampaignCategory FindByKeyForEdit(Int32 __ID)
		{
			Playngo_ClientZone_CampaignCategory entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new Playngo_ClientZone_CampaignCategory();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static Playngo_ClientZone_CampaignCategory FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		/// <returns></returns>
		public static Playngo_ClientZone_CampaignCategory FindByName(String name)
		{
		...
		public static List<Playngo_ClientZone_CampaignCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
        ...
        /// <returns></returns>
        public static List<Playngo_ClientZone_CampaignCategory> FindAllByModuleID(object ModuleID)
        {
            QueryParam qp = new QueryParam();
            int RecordCount = 0;
            qp.Orderfld = _.Sort;
        ...
        public static void MoveField(Playngo_ClientZone_CampaignCategory objTab, EnumMoveType type, object ModuleID)
        {
            List<Playngo_ClientZone_CampaignCategory> siblingTabs = FindAllByModuleID(ModuleID);
            ...
            switch (type)
            {
                case EnumMoveType.Up:
                    ...
                    if (tabIndex > 0)
                    {
                        Playngo_ClientZone_CampaignCategory swapTab = siblingTabs[tabIndex - 1];
        ...
        private static void SwapAdjacentTabs(Playngo_ClientZone_CampaignCategory firstTab, Playngo_ClientZone_CampaignCategory secondTab)
        {
            firstTab.Sort -= 2;
            firstTab.Update();
            secondTab.Sort += 2;
        ...
        private static void UpdateTabOrder(List<Playngo_ClientZone_CampaignCategory> tabs, int increment)
        {
            int tabOrder = 1;
            for (int index = 0; index <= tabs.Count - 1; index++)
            {
                Playngo_ClientZone_CampaignCategory objTab = tabs[index];
        ...
        private static void UpdateTabOrder(List<Playngo_ClientZone_CampaignCategory> tabs, int startIndex, int endIndex, int increment)
        {
        ...
        private static int GetIndexOfTab(Playngo_ClientZone_CampaignCategory objTab, List<Playngo_ClientZone_CampaignCategory> tabs)
        {
        ...
        /// <param name="ModuleId"></param>
        /// <returns></returns>
        public static List<Playngo_ClientZone_CampaignCategory> GetAllCheckList(Int32 ModuleId)
        {
            Int32 RecordCount = 0;
            QueryParam qp = new QueryParam();
            qp.Orderfld = _.Sort;
