...
namespace Playngo.Modules.ClientZone
{
	...
	/// 分类表
	/// </summary>
	public partial class Playngo_ClientZone_GameCategory : Entity<Playngo_ClientZone_GameCategory>
	{
		#region 对象操作
		...
		public static Playngo_ClientZone_GameCategory FindByKeyForEdit(Int32 __ID)
		{
			Playngo_ClientZone_GameCategory entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new Playngo_ClientZone_GameCategory();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static Playngo_ClientZone_GameCategory FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		/// <returns></returns>
		public static Playngo_ClientZone_GameCategory FindByName(String name)
		{
		...
		public static List<Playngo_ClientZone_GameCategory> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
        ...
        /// <returns></returns>
        public static List<Playngo_ClientZone_GameCategory> FindAllByModuleID(object ModuleID)
        {
            QueryParam qp = new QueryParam();
            int RecordCount = 0;
            qp.Orderfld = _.Sort;
        ...
        public static void MoveField(Playngo_ClientZone_GameCategory objTab, EnumMoveType type, object ModuleID)
        {
            List<Playngo_ClientZone_GameCategory> siblingTabs = FindAllByModuleID(ModuleID);
            ...
            switch (type)
            {
                case EnumMoveType.Up:
                    ...
                    if (tabIndex > 0)
                    {
                        Playngo_ClientZone_GameCategory swapTab = siblingTabs[tabIndex - 1];
        ...
        private static void SwapAdjacentTabs(Playngo_ClientZone_GameCategory firstTab, Playngo_ClientZone_GameCategory secondTab)
        {
            firstTab.Sort -= 2;
            firstTab.Update();
            secondTab.Sort += 2;
        ...
        private static void UpdateTabOrder(List<Playngo_ClientZone_GameCategory> tabs, int increment)
        {
            int tabOrder = 1;
            for (int index = 0; index <= tabs.Count - 1; index++)
            {
                Playngo_ClientZone_GameCategory objTab = tabs[index];
        ...
        private static void UpdateTabOrder(List<Playngo_ClientZone_GameCategory> tabs, int startIndex, int endIndex, int increment)
        {
        ...
        private static int GetIndexOfTab(Playngo_ClientZone_GameCategory objTab, List<Playngo_ClientZone_GameCategory> tabs)
        {
        ...
        /// <param name="ModuleId"></param>
        /// <returns></returns>
        public static List<Playngo_ClientZone_GameCategory> GetAllCheckList(Int32 ModuleId)
        {
            Int32 RecordCount = 0;
            QueryParam qp = new QueryParam();
            qp.Orderfld = _.Sort;
