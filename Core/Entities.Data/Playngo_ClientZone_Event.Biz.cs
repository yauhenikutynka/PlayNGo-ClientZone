...
namespace Playngo.Modules.ClientZone
{
	...
	public partial class Playngo_ClientZone_Event : Entity<Playngo_ClientZone_Event>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个事件表实体对象用于表单编辑
		/// </summary>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static Playngo_ClientZone_Event FindByKeyForEdit()
		{
			Playngo_ClientZone_Event entity=Find(new String[]{}, new Object[]{});
			if (entity == null)
			{
				entity = new Playngo_ClientZone_Event();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static Playngo_ClientZone_Event FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<Playngo_ClientZone_Event> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
        ...
        /// <returns></returns>
        public static Playngo_ClientZone_Event FindItemByFriendlyUrl(Int32 ItemId, String FriendlyUrl, Int32 ModuleId)
        {
            int RecordCount = 0;
