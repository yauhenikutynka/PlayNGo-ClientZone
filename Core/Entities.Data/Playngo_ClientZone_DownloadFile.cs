...
namespace Playngo.Modules.ClientZone
{
	...
	[DataObject]
	[Description("下载文件表")]
	[BindTable("Playngo_ClientZone_DownloadFile", Description = "下载文件表", ConnName = "SiteSqlServer")]
	public partial class Playngo_ClientZone_DownloadFile : Entity<Playngo_ClientZone_DownloadFile>
	{
		#region 属性
		private Int32 _ID;
		/// <summary>
		...
		[BindColumn("Version", Description = "", DefaultValue = "", Order = 3)]
        ...
        [Description("游戏编号")]
		[DataObjectField(false, false, false, 200)]
		[BindColumn("GameID", Description = "", DefaultValue = "", Order = 4)]
		...
		[BindColumn("FileTypes", Description = "", DefaultValue = "", Order = 5)]
		public String FileTypes
		{
			get { return _FileTypes; }
			set { if (OnPropertyChange("FileTypes", value)) _FileTypes = value; }
		}
        ...
        [Description("游戏分类")]
		[DataObjectField(false, false, false, 500)]
		[BindColumn("GameCategories", Description = "", DefaultValue = "", Order = 6)]
        ...
        private DateTime _EndTime = DateTime.UtcNow.AddYears(10);
        /// <summary>
        /// 结束时间
        /// </summary>
        [Description("结束时间")]
        ...
        public override Object this[String name]
		{
			get
			{
				switch (name)
				{
					...
					case "FileTypes" : return _FileTypes;
			...
			set
			{
				switch (name)
				{
					...
					case "FileTypes" : _FileTypes = Convert.ToString(value); break;
