...
namespace Playngo.Modules.ClientZone
{
	...
	public partial class Playngo_ClientZone_DownloadFile : Entity<Playngo_ClientZone_DownloadFile>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个下载文件表实体对象用于表单编辑
		/// </summary>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static Playngo_ClientZone_DownloadFile FindByKeyForEdit()
		{
			Playngo_ClientZone_DownloadFile entity=Find(new String[]{}, new Object[]{});
			if (entity == null)
			{
				entity = new Playngo_ClientZone_DownloadFile();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static Playngo_ClientZone_DownloadFile FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<Playngo_ClientZone_DownloadFile> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
        ...
        /// <returns></returns>
        public static List<Playngo_ClientZone_DownloadFile> FindAllByIds(String Ids)
        {
            QueryParam qp = new QueryParam();
            int RecordCount = 0;
