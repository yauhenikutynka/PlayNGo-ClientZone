...
namespace Playngo.Modules.ClientZone
{
	...
	[DataObject]
	[Description("多媒体")]
	[BindTable("Playngo_ClientZone_Files", Description = "多媒体", ConnName = "SiteSqlServer")]
	public partial class Playngo_ClientZone_Files : Entity<Playngo_ClientZone_Files>
	{
		...
		[BindColumn("FileMate", Description = "Mate", DefaultValue = "", Order = 3)]
		...
		[BindColumn("FilePath", Description = "文件路径", DefaultValue = "", Order = 4)]
		...
		[Description("后缀名")]
		[DataObjectField(false, false, false, 32)]
		[BindColumn("FileExtension", Description = "后缀名", DefaultValue = "", Order = 5)]
		...
		[BindColumn("LastTime", Description = "更新时间", DefaultValue = "", Order = 6)]
		...
		[BindColumn("Name", Description = "名称", DefaultValue = "", Order = 11)]
		public String Name
		{
			get { return _Name; }
		...
		[Description("文件大小(KB)")]
		[DataObjectField(false, false, false, 10)]
		[BindColumn("FileSize", Description = "文件大小(KB)", DefaultValue = "0", Order = 12)]
		...
		[Description("图片的宽度")]
		[DataObjectField(false, false, false, 10)]
		[BindColumn("ImageWidth", Description = "图片的宽度", DefaultValue = "0", Order = 13)]
		...
		[Description("图片的高度")]
		[DataObjectField(false, false, false, 10)]
		[BindColumn("ImageHeight", Description = "图片的高度", DefaultValue = "0", Order = 14)]
		...
		[BindColumn("Exif", Description = "相片的扩展信息", DefaultValue = "", Order = 15)]
		public String Exif
		{
			get { return _Exif; }
