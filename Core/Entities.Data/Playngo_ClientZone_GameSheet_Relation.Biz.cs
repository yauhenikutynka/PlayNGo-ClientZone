...
namespace Playngo.Modules.ClientZone
{
	...
	public partial class Playngo_ClientZone_GameSheet_Relation : Entity<Playngo_ClientZone_GameSheet_Relation>
	{
		...
		public static Playngo_ClientZone_GameSheet_Relation FindByKeyForEdit(Int32 __ID)
		{
			Playngo_ClientZone_GameSheet_Relation entity=Find(new String[]{_.ID}, new Object[]{__ID});
			if (entity == null)
			{
				entity = new Playngo_ClientZone_GameSheet_Relation();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static Playngo_ClientZone_GameSheet_Relation FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<Playngo_ClientZone_GameSheet_Relation> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
