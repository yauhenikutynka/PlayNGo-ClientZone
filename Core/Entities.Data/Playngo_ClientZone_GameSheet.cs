...
namespace Playngo.Modules.ClientZone
{
	...
	[DataObject]
	[Description("游戏表格")]
	[BindTable("Playngo_ClientZone_GameSheet", Description = "游戏表格", ConnName = "SiteSqlServer")]
	public partial class Playngo_ClientZone_GameSheet : Entity<Playngo_ClientZone_GameSheet>
	{
		#region 属性
		private Int32 _ID;
		/// <summary>
		...
		[Description("游戏编号 PC")]
		[DataObjectField(false, false, false, 200)]
		[BindColumn("GameID", Description = "游戏编号 PC", DefaultValue = "", Order = 4)]
        ...
        private String _GameID_Mobile = String.Empty;
        /// <summary>
        /// 游戏编号 Mobile
        /// </summary>
        ...
        private String _GameCategories = String.Empty;
        /// <summary>
        /// 游戏分类
        /// </summary>
        [Description("游戏分类")]
		[DataObjectField(false, false, false, 500)]
		[BindColumn("GameCategories", Description = "游戏分类", DefaultValue = "", Order = 6)]
        ...
        [Description("文件集合")]
        [DataObjectField(false, false, true, 1073741823)]
        [BindColumn("Files", Description = "文件集合", DefaultValue = "", Order = 19)]
        public String Files
        {
            get { return _Files; }
		...
		[Description("状态")]
		[DataObjectField(false, false, false, 3)]
		[BindColumn("Status", Description = "状态", DefaultValue = "", Order = 20)]
		public Int32 Status
		{
			get { return _Status; }
		...
		[Description("包含提醒")]
		[DataObjectField(false, false, false, 3)]
		[BindColumn("NotifyInclude", Description = "包含提醒", DefaultValue = "", Order = 21)]
		...
		[Description("提醒状态")]
		[DataObjectField(false, false, false, 3)]
		[BindColumn("NotifyStatus", Description = "提醒状态", DefaultValue = "", Order = 22)]
		...
		private Int32 _NotifySubscribers = 0;
		/// <summary>
		/// 提醒订阅
		/// </summary>
		[Description("提醒订阅")]
		[DataObjectField(false, false, false, 3)]
		[BindColumn("NotifySubscribers", Description = "提醒订阅", DefaultValue = "", Order = 23)]
        ...
        [Description("最后更新时间")]
        [DataObjectField(false, false, false, 23)]
        [BindColumn("LastTime", Description = "最后更新时间", DefaultValue = "", Order = 24)]
		...
		[Description("最后更新用户")]
		[DataObjectField(false, false, false, 10)]
		[BindColumn("LastUser", Description = "最后更新用户", DefaultValue = "", Order = 25)]
		...
		[BindColumn("LastIP", Description = "最后更新IP", DefaultValue = "", Order = 26)]
        ...
        [BindColumn("UrlSlug", Description = "自定义URL", DefaultValue = "", Order = 27)]
        ...
        [Description("邮件发送状态")]
        [DataObjectField(false, false, false, 3)]
        [BindColumn("SendMail", Description = "邮件发送状态", DefaultValue = "", Order = 28)]
        ...
        [Description("发布时间")]
        [DataObjectField(false, false, false, 23)]
        [BindColumn("ReleaseDate", Description = "发布时间", DefaultValue = "", Order = 29)]
