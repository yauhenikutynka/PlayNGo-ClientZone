...
namespace Playngo.Modules.ClientZone
{
	...
	public partial class Playngo_ClientZone_GameSheet : Entity<Playngo_ClientZone_GameSheet>
	{
		...
		#region 扩展查询
		/// <summary>
		/// 根据主键查询一个游戏表格实体对象用于表单编辑
		/// </summary>
		/// <returns></returns>
		[DataObjectMethod(DataObjectMethodType.Select, false)]
		public static Playngo_ClientZone_GameSheet FindByKeyForEdit()
		{
			Playngo_ClientZone_GameSheet entity=Find(new String[]{}, new Object[]{});
			if (entity == null)
			{
				entity = new Playngo_ClientZone_GameSheet();
			}
			return entity;
		}     
		...
		/// <param name="id"></param>
		/// <returns></returns>
		public static Playngo_ClientZone_GameSheet FindByID(Int32 id)
		{
			return Find(_.ID, id);
			// 实体缓存
		...
		public static List<Playngo_ClientZone_GameSheet> Search(String key, String orderClause, Int32 startRowIndex, Int32 maximumRows)
		{
        ...
        /// <returns></returns>
        public static Playngo_ClientZone_GameSheet FindItemByFriendlyUrl(Int32 ItemId, String FriendlyUrl, Int32 ModuleId)
        {
            int RecordCount = 0;
        ...
        /// 查找标题和URL是否存在
        /// </summary>
        /// <param name="GameSheetItem"></param>
        /// <returns></returns>
        public static Boolean FindExists(Playngo_ClientZone_GameSheet GameSheetItem)
        {
            QueryParam qp = new QueryParam();

         

            qp.WhereSql.Append(new SearchParam(_.UrlSlug, GameSheetItem.UrlSlug, SearchType.Equal).ToSql());

            qp.WhereSql.Append(" OR ");


            qp.WhereSql.Append(new SearchParam(_.Title, GameSheetItem.Title, SearchType.Equal).ToSql());
