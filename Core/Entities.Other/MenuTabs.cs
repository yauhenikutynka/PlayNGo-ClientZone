...
namespace Playngo.Modules.ClientZone
{
    ...
    public class MenuTabCollection
    {
        ...
        {
            return _MenuTabItem.ContainsKey(key.ToLower());
        }
        ...
        public Int32 Remove(String key)
        {
            _MenuTabItem.Remove(key.ToLower());
            return _MenuTabItem.Count;
        }
    ...
    /// 标签项
    /// </summary>
    [XmlEntityAttributes("Playngo_ClientZone//Tabs//TabItem")]
