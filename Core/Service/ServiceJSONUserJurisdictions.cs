...
namespace Playngo.Modules.ClientZone
{
    ...
    /// 每个用户选择的区域 获取 / 更新
    /// </summary>
    public class ServiceJSONUserJurisdictions : iService
    {
        public ServiceJSONUserJurisdictions()
        {
        ...
        public void Execute(BasePage Context)
        {
            ...
            if (Context.UserId > 0)
            {
                ...
                String SelectJurisdictions = WebHelper.GetStringParam(Context.Request, "SelectJurisdictions", "");

                if (!String.IsNullOrEmpty(SelectJurisdictions))
                {
                    UserItem.Profile.SetProfileProperty("SelectJurisdictions", SelectJurisdictions);
                }
                else
                {
                    UserItem.Profile.SetProfileProperty("SelectJurisdictions", "-");
                }
                ...
                jsonDatas.Add("SelectJurisdictions", SelectJurisdictions);
