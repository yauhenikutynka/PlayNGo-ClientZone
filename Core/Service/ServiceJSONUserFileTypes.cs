...
{
    /// <summary>
    /// 每个用户选择的File Types 获取 / 更新
    /// </summary>
    public class ServiceJSONUserFileTypes : iService
    {
        public ServiceJSONUserFileTypes()
        {
        ...
        public void Execute(BasePage Context)
        {
            ...
            if (Context.UserId > 0)
            {
                ...
                String SelectJurisdictions = WebHelper.GetStringParam(Context.Request, "SelectFileTypes", "");

                if (!String.IsNullOrEmpty(SelectJurisdictions))
                {
                    UserItem.Profile.SetProfileProperty("SelectFileTypes", SelectJurisdictions);
                }
                else
                {
                    UserItem.Profile.SetProfileProperty("SelectFileTypes", "-");
                }
                ...
                jsonDatas.Add("SelectFileTypes", SelectJurisdictions);
