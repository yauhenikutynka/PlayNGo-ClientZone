<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_GameCategory.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_GameCategory" %>
      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h1><i class="fa clip-gamepad"></i> <%=ViewResourceText("Header_Title", "Game Categories")%></h1>
          </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-12"><i class="fa fa-plus"></i> <%=ViewResourceText("Title_AddNew", "Add New Game Category")%> </div>
                </div>
              </div>
              <div class="form-group">
            ...
            <div class="row">
              ...
              <asp:GridView ID="gvEventList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvEventList_RowDataBound" OnRowCreated="gvEventList_RowCreated" OnSorting="gvEventList_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                             <asp:TemplateField HeaderText="Game Category">
                                <ItemTemplate>
