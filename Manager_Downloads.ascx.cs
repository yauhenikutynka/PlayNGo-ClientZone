...
{
    public partial class Manager_Downloads : BaseModule
    {
        ...
        private void BindPageItem()
        {
            ...
            hlAllEvent.NavigateUrl = xUrl("Status", "-1", "Downloads");
            hlPublishedEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Published).ToString(), "Downloads");
            hlPendingEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Pending).ToString(), "Downloads");
            hlDraftsEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Draft).ToString(), "Downloads");
            hlRecycleBinEvent.NavigateUrl = xUrl("Status", ((Int32)EnumStatus.Recycle).ToString(), "Downloads");
            ...
            hlAddNewLink.NavigateUrl = xUrl("Downloads-Edit");
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            if (!String.IsNullOrEmpty(Search_Title))
            {
                ...
                Where.Add(new SearchParam(Playngo_ClientZone_DownloadFile._.Title, Common.ReplaceEscape(HttpUtility.UrlDecode(Search_Title)), SearchType.Like));
            }
        ...
        protected void btnRemove_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (btnRemove != null && !String.IsNullOrEmpty(btnRemove.CommandArgument))
                {
                    ...
                    Playngo_ClientZone_DownloadFile Event = Playngo_ClientZone_DownloadFile.FindByKeyForEdit(btnRemove.CommandArgument);
            ...
            try
            {
                ...
                if (Status >= 0)
                {
                    ...
                    for (int i = 0; i < Checkbox_Value_Array.Length; i++)
                    {
                        ...
                        {
                            Playngo_ClientZone_DownloadFile Event = Playngo_ClientZone_DownloadFile.FindByKeyForEdit(IDX);
                            if (Event != null && Event.ID > 0)
                            {
