...
{
    public partial class Manager_Modal_Downloads : BaseModule
    {
        ...
        public String CurrentUrl
        {
            get
            {
                ...
                sb.AppendFormat("{0}?Master=Manager_Modal_Downloads&PortalId={1}&TabId={2}&ModuleId={3}&language={4}", "Resource_Masters.aspx", PortalId, TabId, ModuleId, language);
        ...
        private List<SearchParam> BindSearch()
        {
            ...
            Where.Add(new SearchParam(Playngo_ClientZone_DownloadFile._.PortalId, PortalId, SearchType.Equal));
            ...
            if (!String.IsNullOrEmpty(Search_Title))
            {
                ...
                Where.Add(new SearchParam(Playngo_ClientZone_DownloadFile._.Title, HttpUtility.UrlDecode(Search_Title), SearchType.Like));
            }


            if (ViewSettingT<string>("General.MediaLibrary", "Public") == "Private")
            {
                Where.Add(new SearchParam(Playngo_ClientZone_DownloadFile._.LastUser, UserId, SearchType.Equal));
            }
