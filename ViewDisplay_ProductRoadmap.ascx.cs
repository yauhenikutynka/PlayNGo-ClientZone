...
{
    public partial class ViewDisplay_ProductRoadmap : BaseModule
    {
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            try
            {
                ...
                var XMLDB = GetTemplateDB("ProductRoadmap");
        ...
        public Hashtable GetDynamics(Hashtable Puts)
        {
            ...
            var DynamicModules = Playngo_ClientZone_DynamicModule.FindViewAllByFilter(0, (Int32)EnumDynamicModuleType.ProductRoadmap, Settings_ModuleID, this);
