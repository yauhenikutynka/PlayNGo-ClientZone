<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Resource_FeaturedImage.ascx.cs" Inherits="Playngo.Modules.ClientZone.Resource_FeaturedImage" %> 
<div class="container">
    <div class="row">
        <div class="col-sm-8">
      ...
      <!-- end--> 
            ...
            <script type="text/javascript">
                ...
                function ReturnPicture(PictureUrl, PictureID) {
                    ...
                    window.parent.$('#Picture_Modal').modal('hide');
                }
