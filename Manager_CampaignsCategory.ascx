<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_CampaignsCategory.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_CampaignsCategory" %>
      ...
      <div class="row">
        <div class="col-sm-12"> 
          ...
          <div class="page-header">
            <h1><i class="fa fa-dot-circle-o"></i> <%=ViewResourceText("Header_Title", "Campaign Categories")%></h1>
          </div>
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-12"><i class="fa fa-plus"></i> <%=ViewResourceText("Title_AddNew", "Add New Campaign Category")%> </div>
                </div>
              </div>
              <div class="form-group">
                <%=ViewControlTitle("lblName", "Name", "txtName", ":", "")%>
                <asp:TextBox runat="server" ID="txtName" CssClass="form-control  validate[required]" placeholder="Category Name"></asp:TextBox>
            ...
            <div class="row">
              ...
              <asp:GridView ID="gvEventList" runat="server" AutoGenerateColumns="False" OnRowDataBound="gvEventList_RowDataBound" OnRowCreated="gvEventList_RowCreated" OnSorting="gvEventList_Sorting" AllowSorting="true"
                        ...
                        <Columns>
                             <asp:TemplateField HeaderText="Campaign Category">
                                <ItemTemplate>
