<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Manager_Campaigns_Edit.ascx.cs" Inherits="Playngo.Modules.ClientZone.Manager_Campaigns_Edit" %>
<!-- start: PAGE HEADER -->
<div class="row">
    <div class="col-sm-12"> 
        ...
        <div class="page-header">
            <h1><i class="fa fa-dot-circle-o"></i> <%=ViewResourceText("Header_Title", "Campaign Details")%></h1>
        </div>
    ...
    <div class="col-sm-8">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label for="form-field-2">
                        <%=ViewTitle("lblGameID", "Document ID", "txtGameID")%>:</label>
