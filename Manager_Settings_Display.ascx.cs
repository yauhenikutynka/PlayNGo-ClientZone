...
{
    public partial class Manager_Settings_Display : BaseModule
    {
        ...
        private void BindDataToPage()
        {
            ...
            WebHelper.BindList(ddlModulePageType, typeof(EnumDisplayModuleType));
            WebHelper.SelectedListByValue(ddlModulePageType, ViewSettingT<Int32>("ClientZone_ModulePageType", (Int32)EnumDisplayModuleType.ProductRoadmap));
        }
